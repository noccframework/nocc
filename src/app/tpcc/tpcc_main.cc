...
namespace nocc {
  ...
  namespace oltp {
    ...
    namespace tpcc {
...
#ifdef SI_TX
          /* +1 is reserved for the listener */
          //  ts_manager = new TSManager(r,0,current_partition,total_partition,nthreads + 1);
      ...
      std::vector<BenchWorker *> TpccMainRunner::make_workers() {
