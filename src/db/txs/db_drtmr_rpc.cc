...
// This file contains RPC sending and receiving of DrTMR style processing
...
#define META_LENGTH 16 // FIXME!! duplicate with the one in db_drtmr.cc
...
namespace nocc {
  ...
  namespace db {
    ...
    void DBDrtmr::remote_write(int r_idx,char *val,int len) {
    ...
    bool DBDrtmr::lock_remote(yield_func_t &yield) {
    ...
    // RPC handlers ///////////////////////////////////////////////////////////
    void DBDrtmr::lock_rpc_handler(int id,int cid, char *msg,void *arg) {
    ...
    void DBDrtmr::release_rpc_handler(int id,int cid,char *msg,void *arg) {
    ...
    void DBDrtmr::commit_rpc_handler(int id,int cid,char *msg,void *arg) {
#if 1
      ReqHeader *rh = (ReqHeader *)msg;
      char *traverse_ptr = msg + sizeof(ReqHeader);
      int num_items = rh->num;
